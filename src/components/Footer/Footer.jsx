      ...
      <Container fluid className="footerTop">
        <Row>
          ...
          <Col sm={12} md={6} lg={3} className="text-center">
            ...
            <a className="text-decoration-none text-light" href="#">
              <p>RobotLife Business</p>
            </a>
            <a className="text-decoration-none text-light" href="#">
              <p>Partner program</p>
            </a>
            <a className="text-decoration-none text-light" href="#">
              <p>Hosting an RobotLife Hub</p>
            </a>
          </Col>
          <Col sm={12} md={6} lg={3} className="text-center">
            <a className="text-decoration-none" href="#">
              <h5 className="orange">Information</h5>
            </a>
            <a className="text-decoration-none text-light" href="#">
            ...
            <a className="text-decoration-none text-light" href="#">
              <p>RobotLife currency converter</p>
            </a>
          </Col>
          <Col
            sm={12}
            md={6}
            lg={3}
            className="text-light text-center d-flex justify-content-between mt-1"
          >
            <svg
